    ...
    <div class='mart15'>
      <div v-if="this.$route.query.type == '通知公告'">
        <el-card>
          ...
          <!-- 分页 -->
          <div>
            <el-pagination background @current-change='handleCurrentChange1' :current-page='currentPagenotice'
                           :page-size='pageSize' layout='prev, pager, next,total' :total='totalnotice'>
            </el-pagination>
          </div>
        </el-card>
      </div>
      <div v-if="this.$route.query.type == '学院动态'">
        <ul>
          <el-card>
            ...
            <!-- 分页 -->
            <div>
              <el-pagination background @current-change='handleCurrentChange2' :current-page.sync='currentPageschool'
                             :page-size='pageSize' layout='prev, pager, next,total' :total='totalschool'>
              </el-pagination>
            </div>
          </el-card>
        </ul>
      ...
      <div v-if="this.$route.query.type == '工作状态'">
        <ul>
          <el-card>
            ...
            <!-- 分页 -->
            <div>
              <el-pagination background @current-change='handleCurrentChange3' :current-page.sync='currentPagework'
                             :page-size='pageSize' layout='prev, pager, next,total' :total='totalwork'>
              </el-pagination>
            </div>
          </el-card>
        </ul>
